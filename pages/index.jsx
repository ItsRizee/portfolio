...
export default function Home() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 via-gray-900 to-black text-gray-300">
            ...
            <header className="sticky top-0 z-10 bg-slate-600 p-3 shadow-lg shadow-slate-900 md:hidden">
                <nav>
                        ...
                        <li className="cursor-pointer">
                            <Link to="tech-stack" spy={true} smooth={true} offset={-70} duration={300}>
                                <div className="flex items-center space-x-1.5 text-white">
                                    ...
                                    <p className="hover:cursor-pointer text-white">Tech stack</p>
                                </div>
                            </Link>
                        </li>
                    </ul>
            ...
            <main className="flex flex-col relatie h-full w-full p-4 space-y-10">
                <div className="flex flex-col justify-center md:items-center md:flex-row md:space-x-10 md:space-y-0 relatie h-full w-full space-y-10">
                ...
                <section id="tech-stack" className="lg:flex lg:flex-col lg:items-center">
                    <h2 className="text-xl mb-5">Tech stack</h2>
                    <div className="flex items-center overflow-x-auto scrollbar-hide space-x-5">
                        <TechnologyCard image="/nextjs.png" alt="next.js icon" width={256} height={256} link="https://nextjs.org/" />
                        <TechnologyCard image="/react.png" alt="react icon" width={256} height={256} link="https://react.dev/" />
                        <TechnologyCard image="/javascript.png" alt="javascript icon" width={256} height={256} link="https://www.javascript.com/" />
                        <TechnologyCard image="/tailwind.png" alt="tailwind icon" width={256} height={256} link="https://tailwindcss.com/" />
                        <TechnologyCard image="/python.png" alt="python icon" width={256} height={256} link="https://www.python.org/" />
                        <TechnologyCard image="/flutter.png" alt="flutter icon" width={512} height={512} link="https://flutter.dev/" />
                        <TechnologyCard image="/cplusplus.png" alt="C++ icon" width={256} height={256} link="https://isocpp.org/" />
                        <TechnologyCard image="/java.png" alt="java icon" width={256} height={256} link="https://www.java.com/en/" />
                        <TechnologyCard image="/c.png" alt="C icon" width={256} height={256} link="https://www.iso.org/standard/74528.html" />
                    </div>
                </section>
            </main>
        </div>
